...
export type AnalysisStatus = "strong_match" | "match" | "mixed" | "mismatch" | "strong_mismatch" | "insufficient_evidence"
...
export declare const DEFAULT_GROQ_MAX_EVIDENCE_ITEMS: 40
export declare const DEFAULT_GROQ_MAX_BATCHES: 14
...
export declare function normalizePreferencePriority(
  value: unknown,
): AnalysisPriority
...
export declare function mergeBatchClassifications(
...
export declare function buildHotelAnalysisResult(
